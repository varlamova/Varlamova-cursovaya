...
Битрикс CModule*/
Class sladosti_kpi extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "sladosti.kpi";
    var $MODULE_ID = "sladosti.kpi";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("sladosti.kpi_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("sladosti.kpi_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("sladosti.kpi_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("sladosti.kpi_PARTNER_URI");
    }
